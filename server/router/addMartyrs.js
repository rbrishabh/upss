...
var addMartyrs = express.Router();

// middleware that is specific to this router
addMartyrs.use(function timeLog (req, res, next) {
    next();
});

addMartyrs.get('/', function (req, res) {
    res.render('addMartyrs.hbs');
});
